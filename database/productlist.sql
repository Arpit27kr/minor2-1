...
CREATE SCHEMA `full-stack-ecommerce2`;

USE `full-stack-ecommerce2` ;

CREATE TABLE IF NOT EXISTS `full-stack-ecommerce2`.`product_category` (
...
CREATE TABLE IF NOT EXISTS `full-stack-ecommerce2`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `full-stack-ecommerce2`.`workers` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) DEFAULT NULL,
  `description` VARCHAR(255) DEFAULT NULL,
  `unit_price` DECIMAL(13,2) DEFAULT NULL,
